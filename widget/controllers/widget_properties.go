...
func (lp *LumavateProperties) GetGridItemsProperty() *properties.PropertyComponents {
  return &properties.PropertyComponents {
    ...
    [] *properties.Component{}, properties.PropertyOptionsComponent{[] string {"navigation", "video", "text", "app"}, [] *properties.Component {lp.GetNavigationComponent(), lp.GetVideoComponent(), lp.GetTextComponent(), lp.GetAppComponent()} },
  }
}
